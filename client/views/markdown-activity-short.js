...
var RepView = View.extend({
    template: require('../templates/views/markdown-rep.jade'),
    bindings: {
...
var SetGroupView = View.extend({
    template: require('../templates/views/markdown-set-group.jade'),
    render: function () {
...
module.exports = View.extend({
    template: require('../templates/views/markdown-activity-short.jade'),
    bindings: {
        'model.name': {
            type: 'text',
            hook: 'name'
