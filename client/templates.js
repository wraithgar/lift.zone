(function (root, factory) {
    ...
    templatizer["includes"]["activity"] = function tmpl_includes_activity() {
        return '<div class="row"><h6><span data-hook="name"></span><span>&#xa0;</span><span class="circle alert-bg-color"><i data-hook="new" class="fa fa-question"></i></span></h6><ul data-hook="sets" class="no-bullet"></ul><button data-hook="comment" class="label secondary radius"></button><br/><div data-hook="chooseAlias" data-reveal="data-reveal" class="reveal-modal"><ul class="pricing-table"><li class="title">New activity</li><li class="description">This is the first time you\'ve done this activity.</li><li class="bullet-item cta-button"><div class="row"><div class="small-12 medium-6 medium-centered columns"><div class="text-left">I meant what I typed</div><br/><ul class="stack button-group"><li><a href="#" data-hook="name" class="button tiny radius"></a></li></ul><br/></div></div></li><li class="bullet-item cta-button"><div class="row"><div class="small-12 medium-6 medium-centered columns"><div class="text-left">I really meant</div><br/><ul data-hook="suggestions" class="stack button-group"></ul><br/></div></div></li><li class="bullet-item cta-button"><div class="row"><div class="small-12 medium-6 medium-centered columns"><div class="text-left">No, let me go back and edit that</div><br/><ul class="stack button-group"><li class="text-left"><a href="#" class="button tiny radius"><i class="fa fa-arrow-left"></i></a></li></ul><br/></div></div></li></ul></div></div>';
    };
